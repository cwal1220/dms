...
def main(image_base_path, gt_path, save_path):
    os.mkdir(save_path)
...
if __name__ == "__main__":
    main("./WIDER_train/images/", "./wider_face_split/wider_face_train_bbx_gt.txt", "train/")
    main("./WIDER_val/images/", "./wider_face_split/wider_face_val_bbx_gt.txt", "val/")
